...
class TestMainPage:
    ...
    def test_go_to_constructor(self, main_page, login_page, auth_user):
        # Из личного кабинета или ленты — клик на «Конструктор»
        main_page.click_constructor_button()

        # Проверяем, что открылась главная страница (видна кнопка «Оформить заказ»)
    ...
    def test_go_to_order_feed(self, main_page):
        ...
        # Проверяем, что URL изменился на /feed
